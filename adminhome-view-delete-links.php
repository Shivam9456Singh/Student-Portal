      ...
      <div class="sidebar-menu">
        <ul>
          <li class="header-menu">
            <span>View And Delete Links</span>
          </li>
          <li><a href="#latest"><span>Latest Update Links</span></a></li>
          <li><a href="#notice"><span>Noticeboard Links</span></a></li>
			<li class="header-menu">
            <span>Admission</span>
          </li>
			...
			<div class="container">
				<div id="latest" class="msg-box text-center">
					<div class="msg-details text-justify head-title">
						<h4>View & Delete Latest updates Links</h4>
						<div class="hr"></div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <thead class="thead-dark">
                                            ...
                                            <th scope="col">Latest Update Link</th>
                                            <th scope="col">Date & Time</th>
                                            <th scope="col">Delete</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $fileget->get_LatestTable(); ?>
                                        </table>
                                    </div>
                            </div>
                        </div>
    ...
    <div class="msg-wrapper">
			<div class="container">
				<div class="msg-box text-center">
					<div  id="notice" class="msg-details text-justify head-title">
						<h4>View & Delete Notice Board Links</h4>
						<div class="hr"></div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
								<div>
									<h5 class="text-center">Notice Board Links</h5>
									<hr>
                            		<div class="table-responsive">
                                        <table class="table table-striped">
                                        <thead class="thead-dark">
